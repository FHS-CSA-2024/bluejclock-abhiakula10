...
public class ClockDriver
{
    public static void main(String[] args){
        ...
        ClockDisplay test2 = new ClockDisplay(03,45);
        String test2Output = test2.getTime();
        System.out.println(" 2 arg. Con test " +test2Output);
        
        
        ClockDisplay tickTest1 = new ClockDisplay(03,32);
        System.out.println("The time before the tick is: " + tickTest1.getTime());
        tickTest1.timeTick();
        System.out.println(" The time after the tick is: " + tickTest1.getTime());
        
        ClockDisplay tickTest2 = new ClockDisplay(03,09);
        System.out.println(" The time before the tick is: " + tickTest2.getTime());
        tickTest2.timeTick();
        System.out.println(" The time after the tick is: " + tickTest2.getTime());
        
        ClockDisplay tickTest3 = new ClockDisplay(01,59);
        System.out.println(" The time before the tick is: " + tickTest3.getTime());
        tickTest3.timeTick();
        System.out.println(" The time after the tick is: " + tickTest3.getTime());
        
        ClockDisplay tickTest4 = new ClockDisplay(09,59);
        System.out.println("The time before the tick is: " + tickTest4.getTime());
        tickTest4.timeTick();
        System.out.println(" The time after the tick is: " + tickTest4.getTime());
        
        ClockDisplay tickTest5 = new ClockDisplay(23,59);
        System.out.println("The time before the tick is: " + tickTest5.getTime());
        tickTest5.timeTick();
        System.out.println(" The time after the tick is: " + tickTest5.getTime());
        ...
        ClockDisplaySeconds tickTest1Sec = new ClockDisplaySeconds(03,32,59);
        ...
        ClockDisplaySeconds tickTest2Sec = new ClockDisplaySeconds(01,00,59);
        ...
        ClockDisplaySeconds tickTest3Sec = new ClockDisplaySeconds(01,59,59);
